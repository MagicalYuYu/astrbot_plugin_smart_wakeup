...
[![Version](https://img.shields.io/badge/version-2.0.1-blue?style=flat-square)](https://github.com/MagicalYuYu/astrbot_plugin_smart_wakeup)
...
- 🔧 **143 Tunable Parameters** — 14 config groups, from energy recovery to topic weights
...
- **Grouped Tabs** — 143 parameters organized into 14 config groups, no more endless scrolling
...
All 143 parameters have sensible defaults and work out of the box. For detailed configuration, see the [Usage Guide](docs/usage_guide.md) (Chinese).
